...
Download the dataset and add it to the data/ folder — see data/SOURCE.md for the download link and data/README.md for the exact filenames/columns expected.
Run the app:
...
Citation: Anik, F. W., Zaman, M., Foyez, T., & Mamun, K. A. DOSAGE: A Dataset for Optimized Safe Antibiotic Guidelines and Estimates, Nature Scientific Data, 2025. DOI: https://www.doi.org/10.1038/s41597-025-05761-8
